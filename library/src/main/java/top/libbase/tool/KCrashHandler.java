 ...
 * 
 */
public class KCrashHandler implements UncaughtExceptionHandler {
...
//             // 如果<span style="background-color: rgb(255, 255, 255); ">没有NEW_TASK标识�?</span>是UI线程抛的异常则界面卡死直到ANR
...
//			public void run() {
//				Looper.prepare();
//			//	Toast.makeText(mActivity, "抱歉~软件异常 正在为您重启!", Toast.LENGTH_LONG).show();
//				Looper.loop();
//			}
//		}.start();
		//收集设备参数信息 
	...
	@SuppressLint("SdCardPath") private String saveCrashInfo2File(Throwable ex) {
		...
		try {
			...
			if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
				String path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/EveryImg/aoacgcrash/";
